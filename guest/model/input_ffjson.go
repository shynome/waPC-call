		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'n':
					...
					if bytes.Equal(ffjKeyInputName, kn) {
						currentKey = ffjtInputName
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.SimpleLetterEqualFold(ffjKeyInputName, kn) {
					currentKey = ffjtInputName
					state = fflib.FFParse_want_colon
					goto mainparse
				}
